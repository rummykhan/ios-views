...
class GithubTableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.data = GithubDataManager.getData()
        self.tblView.dataSource = self
        self.tblView.delegate = self
        self.tblView.separatorColor = UIColor.clear
        self.tblView.rowHeight = 260
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let user = self.data![indexPath.row] as Dictionary<String, Any>? {
            cell.user = user
        }
